...
public class MsgHandle extends Handler {
     ...
     */
    public void setCancelBlock(Runnable cancelBlock) {
        mCancelBlock = cancelBlock;
    }

    /**
     * exec the Cancel Function
     */
    public void execCancelBlock() {
        mCancelBlock.run();
    }

    /**
     * is set Cancel Function
     */
    public boolean isExistCancelBlock() {
        return mCancelBlock != null;
    }
