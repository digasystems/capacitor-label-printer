...
public class Activity_StartMenu extends Activity {
    ...
    private void init() {
        ...
        try {
            ...
            raw2file("TD2030A_40mm40mm.bin", R.raw.td2030a_40mm40mm);
            raw2file("TD2030A_57mm.bin", R.raw.td2030a_57mm);
            raw2file("TD2125N_40mm40mm.bin", R.raw.td2125n_40mm40mm);
            raw2file("TD2125N_57mm.bin", R.raw.td2125n_57mm);
            raw2file("TD2125NWB_40mm40mm.bin", R.raw.td2125nwb_40mm40mm);
            raw2file("TD2125NWB_57mm.bin", R.raw.td2125nwb_57mm);
            raw2file("TD2135N_40mm40mm.bin", R.raw.td2135n_40mm40mm);
            raw2file("TD2135N_57mm.bin", R.raw.td2135n_57mm);
            raw2file("TD2135NWB_40mm40mm.bin", R.raw.td2135nwb_40mm40mm);
            raw2file("TD2135NWB_57mm.bin", R.raw.td2135nwb_57mm);
    ...
    private void setPreferences() {
        ...
        if (sharedPreferences.getString("printerModel", "").equals("")) {
            ...
            editor.putString("rotation", printerInfo.rotation.toString());
    ...
    private void setListView() {
        ...
        activityClass.put(5, Activity_PrinterSpec.class);
        ...
        mListItems.add(getString(R.string.text_printer_spec));
