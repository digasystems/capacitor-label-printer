...
public abstract class BasePrint {
    ...
    private void getPreferences() {
        ...
        mPrinterInfo.pjFeedMode = PrinterInfo.PjFeedMode
                .valueOf(sharedPreferences.getString("pjFeedMode",
                        PrinterInfo.PjFeedMode.PJ_FEED_MODE_FIXEDPAGE.toString()));
        ...
        manualCustomPaperSettingsEnabled = Boolean
                .parseBoolean(sharedPreferences.getString("enableManualCustomPaperSettings", Boolean.FALSE.toString()));
    ...
    // PaperKind paperKind =
    // PaperKind.valueOf(sharedPreferences.getString("rjPaperKind", "ROLL"));
    // float width = parseFloat(sharedPreferences.getString("rjPaperWidth", ""),
    // 0.0f);
    // float length = parseFloat(sharedPreferences.getString("rjPaperLength", ""),
    // 0.0f);
    // float rightMargin =
    // parseFloat(sharedPreferences.getString("rjPaperRightMargin", ""), 0.0f);
    // float leftMargin =
    // parseFloat(sharedPreferences.getString("rjPaperLeftMargin", ""), 0.0f);
    // float topMargin = parseFloat(sharedPreferences.getString("rjPaperTopMargin",
    // ""), 0.0f);
    // float bottomMargin =
    // parseFloat(sharedPreferences.getString("rjPaperBottomMargin", ""), 0.0f);
    // float labelPitch =
    // parseFloat(sharedPreferences.getString("rjPaperLabelPitch", ""), 0.0f);
    // float markPosition =
    // parseFloat(sharedPreferences.getString("rjPaperMarkPosition", ""), 0.0f);
    // float markHeight =
    // parseFloat(sharedPreferences.getString("rjPaperMarkHeight", ""), 0.0f);
    // Unit unit = Unit.valueOf(sharedPreferences.getString("rjPaperUnit",
    // Unit.Mm.name()));

    // CustomPaperInfo customPaperInfo;
    // switch (paperKind) {
    // case DIE_CUT:
    // customPaperInfo = CustomPaperInfo.newCustomDiaCutPaper(printerModel, unit,
    // width, length, rightMargin, leftMargin, topMargin, bottomMargin, labelPitch);
    // break;
    // case MARKED_ROLL:
    // customPaperInfo = CustomPaperInfo.newCustomMarkRollPaper(printerModel, unit,
    // width, length, rightMargin, leftMargin, topMargin, bottomMargin,
    // markPosition, markHeight);
    // break;
    // case ROLL:
    // default:
    // customPaperInfo = CustomPaperInfo.newCustomRollPaper(printerModel, unit,
    // width, rightMargin, leftMargin, topMargin);
    // break;
    // }
    ...
    public String getBattery() {
        ...
        if (mPrintResult.maxOfBatteryResidualQuantityLevel == 0) {
            ...
            double ratio = (double) mPrintResult.batteryResidualQuantityLevel
